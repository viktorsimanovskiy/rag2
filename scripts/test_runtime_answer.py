...
def _parse_intent(value: str) -> QuestionIntentEnum:
    ...
    mapping = {
        ...
        "eligibility_question": QuestionIntentEnum.ELIGIBILITY_QUESTION,
        "eligible": QuestionIntentEnum.ELIGIBILITY_QUESTION,
        "categories": QuestionIntentEnum.ELIGIBILITY_QUESTION,
        "category": QuestionIntentEnum.ELIGIBILITY_QUESTION,
